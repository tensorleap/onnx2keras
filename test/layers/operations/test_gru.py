...
class GRU(torch.nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, bias=True, batch_first=False, bidirectional=False):
        ...
        self.gru_layer = torch.nn.GRU(input_size=input_size, hidden_size=hidden_size, num_layers=num_layers,
...
def test_gru(bias, batch_first, bidirectional):
    input_size = 10
    hidden_size = 20
    num_layers = 2
    pt_model = GRU(input_size, hidden_size, num_layers, bias, batch_first, bidirectional)
