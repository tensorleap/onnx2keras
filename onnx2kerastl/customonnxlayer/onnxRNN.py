...
class OnnxRNN(Layer):
    ...
    def __init__(self, units: int, return_sequences: bool, return_states: bool, bidirectional: bool,
                 activation: str, **kwargs):
        super().__init__(**kwargs)
        self.gru_layer = tf.keras.layers.SimpleRNN(units, return_sequences=return_sequences,
                                               return_state=return_states, activation=activation)
        if bidirectional:
